...
- **Python 3.8+**
- **Foundry Local** running locally with OpenAI-compatible API (typically `http://localhost:11434/v1/chat/completions`)
...
```bash
# Override endpoint
export CCP_FOUNDRY_LOCAL_ENDPOINT="http://localhost:8000/v1/chat/completions"
...
**Error:** `Cannot connect to Foundry Local. Please ensure it's running: foundry-local serve`
